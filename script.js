...
const backgroundPictures = [
    'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?w=1920&q=80', // Mountain landscape
    'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1920&q=80', // Ocean beach
    'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1920&q=80', // Forest path
    'https://images.unsplash.com/photo-1474524955719-b1d202f99ad5?w=1920&q=80', // Sunset sky
    'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=1920&q=80', // Snowy mountain peak
    'https://images.unsplash.com/photo-1438786657495-640937046d18?w=1920&q=80', // Calm lake
    'https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=1920&q=80', // Desert dunes
    'https://images.unsplash.com/photo-1501785886872-3a3517e4d092?w=1920&q=80', // Starry night
    'https://images.unsplash.com/photo-1493246507139-91e8fad9978e?w=1920&q=80', // Rolling hills
    'https://images.unsplash.com/photo-1511300636408-a63a89df6d46?w=1920&q=80', // Waterfall
];
...
function showNewQuote() {
    fetch('https://api.freeapi.app/api/v1/public/quotes/quote/random')
        ...
        .then(data => {
            ...
            const picture = backgroundPictures[Math.floor(Math.random() * backgroundPictures.length)];
...
function shareOnTwitter() {
    ...
    const twitterLink = `https://twitter.com/intent/tweet?text=${encodeURIComponent(fullText)}`;
